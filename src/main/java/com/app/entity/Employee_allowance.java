...
public class Employee_allowance {
	...
	public Employee_allowance(Integer request_no, String code, String remarks, String completed_service,
			...
			String so_date, String generated_date, String subject, String note_para1, String note_para2,
			String vendor_name, String ifd_date, String from_date, String to_date, String travel_date, File doc_image,
			File getGpf_doc, String noofchilds) {
		super();
	...
	public String toString() {
		return "Employee_allowance [request_no=" + request_no + ", code=" + code + ", remarks=" + remarks
				...
				+ ", so_date=" + so_date + ", generated_date=" + generated_date + ", subject=" + subject
				+ ", note_para1=" + note_para1 + ", note_para2=" + note_para2 + ", vendor_name=" + vendor_name
				+ ", ifd_date=" + ifd_date + ", from_date=" + from_date + ", to_date=" + to_date + ", travel_date="
				+ travel_date + ", noofchilds=" + noofchilds + ", doc_image=" + doc_image + ", getGpf_doc=" + getGpf_doc
				+ "]";
	}
