...
$(document).ready(function(){
	$.ajax({
		type : "get",
		url : "./getAllLTCEncashForNSPrints",
		cache : false,
...
function geneatens(a){
	...
	document.forms[0].action="./getLTCEncashForNSPrints";
...
<%@include file="/WEB-INF/views/banner.jsp"%>
	...
	<div align="center">
		<h6 class="h6 font-weight-bolder text-primary">APPROVED DETAILS FOR GEM - Encashment</h6>
	</div>
