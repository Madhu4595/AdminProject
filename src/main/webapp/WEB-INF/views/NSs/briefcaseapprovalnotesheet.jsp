			...
			<div class="col-md-12">
				<div>
					...
					<div> 
						...
						dt. <%=billdate%> for 
						Rs. ${employee_allowance2.amount_claimed}/- ${employee.callSign} ${employee.name} is eligible for <b> Rs. ${employee_allowance2.amount_approved}/- ( Rupees <span id="words" ></span> ) </b> as per his entitlement.
					</div>
					<br>
					<div>
