			...
			for (var i = 0; i < response.length; i++) {
				...
				$("#tbody").append(
						'<tr><td>' + gem.requestno
								...
								+'<td><a href=\"generateGEMVehicleNoteSheet?requestno='+gem.requestno+'\">Generate NoteSheet</a></td></tr>');
			}
...
<%@include file="banner.jsp"%>
	...
	<div align="center">
		...
		<div class="container border" style="background-color: #e6f9ff; width: 50%;" >
			<form:form action="./generateGEMVehicleNoteSheet" method="post">
				<div class="row g-3 align-items-center m-4 p-4">
					...
					<div class="col-auto m-4">
						<input type="submit" value="Note Sheet" class="btn btn-success"
