		...
		$.ajax({
			...
			success: function(resp){
				...
				if(resp.length > 0){
					...
					alert("No data is available for approval");
				}
...
<body>
	...
	<div align="center">
		<h6 class="h6 font-weight-bolder text-danger"> BRIEFCASE
			ALLOWANCE NOTESHEET FORM</h6>
	</div>
	<div class="container border"
		style="background-color: #e6f9ff; border-radius: 20px;">
		<form name="searchform">
		<input type="hidden" name="notesheet" value="NS"/>
	...
	<c:if test="${open}">
		<div align="center">
			...
			<form:form action="./generateBriefNSPrint" method="post">
				<div class="container m-4 border shadow-lg w-50"
					...
					<div class="row g-3 align-items-center ">
						<div class="col-6">
							Amount Claimed: <input type="text" name="amountClaimed"
								id="amountClaimed" value="${bean.amountClaimed }"
								class="form-control" readonly="readonly" />
						</div>
						<div class="col-6">
							Amount Approved: <input type="text" name="amountApproved"
								id="amountApproved" class="form-control" />
						</div>
					</div>
