...
.ready(
		function() {
			...
			$
					.ajax({
						type : "get",
						url : "./getAllGemVehicleForSOPrints",
						cache : false,
...
function generateSO(a) {
	...
	document.forms[0].action="./generateGEMVehicleSOPrints";
...
<center>
	<span style="color:blue; font-weight:bolder;">SANCTIONED DETAILS FOR GEM - Vehicle</span><br>
