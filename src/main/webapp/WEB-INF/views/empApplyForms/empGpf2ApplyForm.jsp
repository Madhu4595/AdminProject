...
$.ajax({
	 ...
	 success:function(resp){
		...
		// alert(resp.length);
		// $("#financialYear").empty();
		 $("#financialYear").append('<option value="">-select-</option>');
		 for(var k=0; k<resp.length; k++){
			 var bean = resp[k];
			 $("#financialYear").append('<option value="'+bean+'">'+bean+'</option>');
		 }
	 }
});
</script>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-9"
				...
				<div align="center">
					<div class="col-sm-12">
						<h6 class="h6 text-primary" style="text-decoration: underline;">EMPLOYEE GPF
					ADVANCE APPLY FORM</h6>
					</div>
				</div>


				<form:form action="./saveEmpGpfAdvanceApplyForms"
					modelAttribute="bean" method="post">

  					<div class="row"> 
<!-- 						<div class="col-6"> -->
<!-- 							<label>Employee Code</label> -->
							<input type="hidden" name="empCode"
								id="empCode" value="${emp.code }" class="form-control" />
<!-- 						</div> -->
						<div class="col-6">
							<label>GPF Account No.</label> <input type="text" name="gpfAccNo"
					...
					<div class="row form-inline">
						<div class="col-6">
							<label>i. Closing balance as per statement for the year</label> <select
								name="financialYear" id="financialYear" class="form-control"
								style="width: 47%;">
							</select> <input type="text" name="closingBalance" id="closingBalance"
								class="form-control" style="width: 52%;" placeholder="Rs." />
						</div>
						<div class="col-6">
							<label>ii. Credit on account of monthly subscription </label> <input
								type="text" name="creditOnAccountFrom" id="creditOnAccountFrom"
								class="form-control" placeholder="From" style="width: 29%;" />
							<input type="text" name="creditOnAccountTo"
								id="creditOnAccountTo" class="form-control" placeholder="To"
								style="width: 29%;" /> <input type="text"
								name="creditOnAccountRs" id="creditOnAccountRs"
								class="form-control" style="width: 40%;" placeholder="Rs." />
						</div>
					</div>
					<div class="row form-inline">
						<div class="col-6">
							<label>iii. Refund </label> <input type="text" name="refundFrom"
								id="refundFrom" class="form-control" placeholder="From"
								style="width: 29%;" /> <input type="text" name="refundTo"
								id="refundTo" class="form-control" placeholder="To"
								style="width: 29%;" /> <input type="text" name="refundRs"
								id="refundRs" class="form-control" style="width: 40%;"
								placeholder="Rs." />
						</div>
						<div class="col-6">
							<label>iv. Total </label> <input type="text" name="total"
								id="total" class="form-control" style="width: 100%;" />
						</div>
					</div>
					<div class="row form-inline">
						<div class="col-6">
							<label>v. withdrawal during period </label> <input type="text"
								name="withdrawPeriodFrom" id="withdrawPeriodFrom"
								style="width: 28%;" class="form-control" placeholder="From" />
							<input type="text" name="withdrawPeriodTo" id="withdrawPeriodTo"
								style="width: 30%;" class="form-control" placeholder="To" /> <input
								type="text" name="withdrawAmt" id="withdrawAmt"
								style="width: 40%;" class="form-control" placeholder="Rs" />
						</div>
						<div class="col-6">
							<label>vi. Net balance at credit </label> <input type="text"
								name="netCreditBalance" id="netCreditBalance"
					...
					<div class="row">
						<div class="col-6">
							<label>Amount of advance outstanding </label> <input type="text"
								name="amtAdvanceOutstanding" id="amtAdvance"
								class="form-control" style="width: 100%;" />
						</div>
						<div class="col-6">
							<label>Amount of advance required </label> <input type="text"
								name="amtAdvanceRequired" id="amtAdvanceRequired"
								class="form-control" style="width: 100%;" />
						</div>
					</div>
					<div class="row">
						<div class="col-6">
							<label>Purpose for which the advance is required</label> <input
								type="text" name="advancePurpose" id="advancePurpose"
								class="form-control" style="width: 100%;" />
						</div>
						<div class="col-6">
							<label>Rules under which the request is covered</label> <input
								type="text" name="requestRulesCovered" id="requestRulesCovered"
								class="form-control" style="width: 100%;" />
						</div>
					</div>
					...
					<div class="row">
						<div class="col-6">
							<label class="form-label"> Location & measurement of the
								Plot </label> <input type="text" class="form-control"
								name="plotLocAndMeasure">
						</div>
						<div class="col-6">
							<label class="form-label"> Whether plot is free hold or
								on lease </label> <input type="text" class="form-control"
								name="plotFreehold">
						</div>
					</div>
					<div class="row">
						<div class="col-6">
							<label class="form-label"> Plan for construction </label> <input
								type="text" class="form-control" name="planForConstruction">
						</div>
						<div class="col-6">
