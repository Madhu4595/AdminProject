...
<body>
	...
	<div class="container border p-4 font-weight-bolder"
		...
		<form:form action="./updateltcadvanceEnacachment" method="post"
			modelAttribute="updateltc">
			<div class="row align-items-center m-2">
				...
				<div class="col-auto">
					<input type="text" name="requestno" id="requestno"
						class="form-control" maxlength="9" /> <span></span>
				</div>
			...
			<div class="row g-3 align-items-center m-2">
				...
				<!-- 					<label for="totalfare" class="col-form-label">Encashment -->
