...
for(CEA cea:list){
	totAmt = totAmt + cea.getAmount_approved();
	
	LocalDateTime now = cea.getNsDate();  
			...
			<div class="col-md-12">
				...
				<div>
						...
						<table class="table table-bordered table-stripped">
							...
							System.out.println("empsListttttttttttttttttttttttt=> "+empsList.size());
