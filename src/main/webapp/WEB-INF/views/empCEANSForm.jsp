			...
			try {
				...
				for(var j=0; j< arraycodes.length;j++){
					...
					for(var i=0; i<allAllowances.length;i++){
						...
						var allowances = allAllowances[i];
						//alert("allowances.emp_code => "+allowances.empCode);
...
//             for (i = 1; i <= document.getElementById("param").value; i++) {
...
<body>
	...
	<div align="center">
		<h3 class="h5 font-weight-bolder text-primary">EMPLOYEE CEA ALLOWANCES NOTESHEET FORM</h3>
	</div>
