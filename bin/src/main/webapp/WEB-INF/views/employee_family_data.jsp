			...
			<div>
				...
				<table style="BORDER-COLLAPSE: collapse;" width="90%" align="right"
					...
					<c:forEach var="ef" items="${emp_family }">
						<tr>
							<td> <input style="width: 300px;" name="per_name" maxlength="50" value="${ef.per_name }"/></td>
							<td><input name="relation" maxlength="50" value="${ef.relation }"/></td>
							<td><input type="date" name="editdob" maxlength="10" value="${ef.dob }"/></td>
							<td><input name="editdependency" maxlength="10" value="${ef.dependency }"/></td>
					...
					<tr>
						<td><input type="text" style="width: 300px;" name="per_name" maxlength="50" /></td>
						...
						<td><input type="text" name="cghsCode" /></td>
