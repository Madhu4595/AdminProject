...
//					alert("response=> "+JSON.stringify(response));
	...
	function relationsearch() {
		...
		$.getJSON('./relationsearch.action?eno=' + eno + "&patient_name=" + patient_name,
						function(response) {
							if (response) {
...
<body>
	...
	<form:form action="./billsupload" method="post"
		...
		<section class="container mt-1 shadow py-5" id="section">
				...
				<div>
					<table style="BORDER-COLLAPSE: collapse;" width="90%"
						...
						<tr class="sendhead1">
							...
							<th width="100px;">Type of Bills</th>
							<th width="100px;">Add/Delete</th>
						</tr>
						<tr style="border-top: 10px solid; border-bottom: 10px solid; border-color: transparent;">
							<td style="width: 400px;"><form:input class="form-control billno m-1" path="bill_no" maxlength="50" /></td>
							<td style="width: 400px;"><form:input type="date" class="form-control mul_date  m-1" path="bill_date" maxlength="50" /></td>
							<td style="width: 400px;"><form:input type="text" class="form-control mul_amt  m-1" path="amount_claimed" maxlength="10" /></td>
							<td style="width: 400px;"><form:input type="text" class="form-control mul_labname  m-1" path="lab_name" maxlength="30" /></td>
						<!--<td  style="width:400px;"><input type="button"  style="" class="buttoncolor" name="add" value="add" onclick="addOwner(this)" /></td> -->

							<td  ><input type="button"   class="buttoncolor m-1" name="add" value="Add" onclick="addOwner(this)" /></td>
							<td  ><input type="button"  class="buttoncolor m-1" name="remove" value="Remove" onclick="removeOwner(this)" /></td>
						</tr>
					</table>
